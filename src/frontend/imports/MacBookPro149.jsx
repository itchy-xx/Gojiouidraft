...
function LoginForm() {
    return (<div className="absolute h-[625px] left-[85px] top-[179px] w-[388px]" data-name="Login Form">
      <Intro />
...
function Form() {
    return (<div className="absolute h-[92px] left-[446px] top-[317px] w-[388px]" data-name="Form">
...
function LeftSide8Column() {
    return (<div className="absolute h-[804px] left-[238px] top-[56px] w-[558px]" data-name="Left side 8 Column">
      <LoginForm />
      <Form />
    </div>);
}
export default function MacBookPro() {
    return (<div className="bg-white relative size-full" data-name="MacBook Pro 14' - 9">
      <LeftSide8Column />
