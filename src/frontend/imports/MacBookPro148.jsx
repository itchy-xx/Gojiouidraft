...
function Avatar() {
    return (<div className="bg-[#78e378] content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[100px] shrink-0 size-[48px]" data-name="Avatar">
...
function Name() {
    return (<div className="content-stretch flex items-center not-italic relative shrink-0 w-full" data-name="Name">
...
function Message() {
    return (<div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Message">
...
function Texts() {
    return (<div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px overflow-clip relative" data-name="Texts">
      <Name />
      <Message />
    </div>);
}
function Avatar1() {
    return (<div className="bg-[#f566dd] content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[100px] shrink-0 size-[48px]" data-name="Avatar">
...
function Avatar2() {
    return (<div className="relative rounded-[100px] shrink-0 size-[48px]" data-name="Avatar">
...
function Frame() {
    return (<div className="relative rounded-[4px] shrink-0 size-[18px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[4px] size-full" src={imgFrame1}/>
    </div>);
}
function Message2() {
    return (<div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Message">
...
function Search1() {
    return (<div className="relative shrink-0 size-[24px]" data-name="Search">
...
function Search() {
    return (<div className="bg-[#f5f5f5] flex-[1_0_0] h-[40px] min-h-px min-w-px relative rounded-[22px]" data-name="Search">
...
function EmojiIcon() {
    return (<div className="relative shrink-0 size-[24px]" data-name="Emoji Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Emoji Icon">
...
function SendIcon() {
    return (<div className="relative shrink-0 size-[24px]" data-name="Send Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Send Icon">
...
function InputBar({ className }) {
    return (<div className={className || "absolute bg-white content-stretch flex gap-[16px] h-[56px] items-center left-[558px] px-[16px] py-[8px] rounded-[12px] top-[898px] w-[694px]"} data-name="Input Bar">
      <EmojiIcon />
...
function HeartIcon() {
    return (<div className="relative shrink-0 size-[18px]" data-name="heart icon">
...
function CheckIcon() {
    return (<div className="relative shrink-0 size-[14px]" data-name="check Icon">
...
function TimeEmojiIcon() {
    return (<div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Time (Emoji(Icon)">
      <HeartIcon />
...
function Message4() {
    return (<div className="bg-white content-stretch flex flex-col gap-[4px] items-end justify-center px-[12px] py-[4px] relative rounded-[12px] shrink-0" data-name="Message">
...
function MessageOtherUser({ className }) {
    return (<div className={className || "absolute content-stretch flex items-center left-[437px] top-[226px] w-[646px]"} data-name="Message(Other User)">
      <Message4 />
    </div>);
}
function HeartIcon1() {
...
function Message5() {
    return (<div className="bg-[#dde2ff] content-stretch flex flex-col gap-[4px] items-end justify-center px-[12px] py-[4px] relative rounded-[12px] shrink-0" data-name="Message">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#011627] text-[16px] whitespace-nowrap">
        <p className="mb-0">Hello! Thank you all for joining me in this art class,</p>
        <p className="mb-0">I look forward to seeing you all soon!</p>
        <p className="mb-0">&nbsp;</p>
...
function Message6() {
    return (<div className="bg-[#dde1ff] content-stretch flex flex-col gap-[4px] items-end justify-center px-[12px] py-[4px] relative rounded-[12px] shrink-0" data-name="Message">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#011627] text-[16px] whitespace-nowrap">
...
function Avatar4() {
    return (<div className="mr-[-8px] relative rounded-[100px] shrink-0 size-[40px]" data-name="Avatar">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[100px] size-full" src={imgAvatar}/>
    </div>);
}
function Avatar5() {
...
function Avatars() {
    return (<div className="content-stretch flex items-center pr-[8px] relative shrink-0" data-name="avatars">
      <Avatar4 />
      <Avatar5 />
      <Avatar6 />
    </div>);
...
function Name4() {
    return (<div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Name">
...
function LastSeen() {
    return (<div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Last Seen">
...
function OtherUser() {
    return (<div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="(Other User)">
      <div className="flex flex-row items-center size-full">
...
function SearchIcon() {
    return (<div className="absolute inset-[20%]" data-name="search icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="search icon">
          <path d={svgPaths.pcc952f1} fill="var(--fill-0, #707991)" id="Vector"/>
        </g>
...
function SearchMessages() {
    return (<div className="relative rounded-[100px] shrink-0 size-[40px]" data-name="Search Messages">
      <SearchIcon />
    </div>);
}
function CallIcon1() {
    return (<div className="relative shrink-0 size-[24px]" data-name="call icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="call icon">
...
function CallIcon() {
    return (<div className="content-stretch flex items-start p-[8px] relative rounded-[100px] shrink-0" data-name="Call Icon">
      <CallIcon1 />
    </div>);
}
function MoreIcon1() {
    return (<div className="absolute inset-[20%]" data-name="more icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="more icon">
...
function MoreIcon() {
    return (<div className="relative rounded-[100px] shrink-0 size-[40px]" data-name="More Icon">
      <MoreIcon1 />
    </div>);
}
function TopBarGroup({ className }) {
    return (<div className={className || "absolute bg-white content-stretch flex gap-[8px] h-[83px] items-start left-[344px] px-[16px] py-[8px] top-0 w-[1169px]"} data-name="Top Bar (Group)">
...
function Avatar7() {
    return (<div className="absolute left-[374px] rounded-[100px] size-[40px] top-[797px]" data-name="Avatar">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[100px] size-full" src={imgAvatar3}/>
    </div>);
}
function Avatar8() {
    return (<div className="absolute left-[374px] rounded-[100px] size-[40px] top-[296px]" data-name="Avatar">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[100px] size-full" src={imgAvatar2}/>
    </div>);
}
function Image() {
    return (<div className="absolute h-[268px] left-[437px] rounded-[16px] top-[569px] w-[338px]" data-name="Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[16px] size-full" src={imgFrame1}/>
    </div>);
}
function DateGroup() {
    return (<div className="bg-[#7d81b1] content-stretch flex flex-col items-end justify-center px-[12px] py-[4px] relative rounded-[12px] shrink-0" data-name="Date Group">
...
function Time() {
    return (<div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Time">
...
function Message7() {
    return (<div className="bg-[#dadada] content-stretch flex flex-col gap-[4px] items-end justify-center px-[12px] py-[4px] relative rounded-[12px] shrink-0" data-name="Message">
...
function MessageYou({ className }) {
    return (<div className={className || "absolute content-stretch flex items-center justify-end left-[1383px] top-[389px] w-[94px]"} data-name="Message(You 2)">
      <Message7 />
    </div>);
}
export default function MacBookPro() {
    return (<div className="bg-[#f4f5f7] relative size-full" data-name="MacBook Pro 14' - 8">
