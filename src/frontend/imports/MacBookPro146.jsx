...
function Intro() {
    return (<div className="absolute content-stretch flex flex-col items-start left-0 top-0" data-name="Intro">
...
function Form() {
    return (<div className="absolute content-stretch flex flex-col gap-[24px] items-end justify-center left-0 top-[84px] w-[388px]" data-name="Form">
...
function SocialSignIn() {
    return (<div className="absolute content-stretch flex flex-col items-start left-0 top-[512px]" data-name="Social Sign in">
      <Or />
    </div>);
}
function LoginForm() {
    return (<div className="h-[625px] relative shrink-0 w-[388px]" data-name="Login Form">
      <Intro />
      <Form />
      <SocialSignIn />
...
export default function MacBookPro() {
    return (<div className="bg-white relative size-full" data-name="MacBook Pro 14' - 6">
