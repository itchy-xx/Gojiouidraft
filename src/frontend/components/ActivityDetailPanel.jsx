...
export const ActivityDetailPanel = ({ activity, isInterested, onToggleInterest, onClose, currentUserId, }) => {
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <img src={activity.organiserAvatar} alt={activity.organiserName} className="w-8 h-8 rounded-full"/>
              <div>
          ...
          <div className="space-y-3 border-t border-b py-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                {Math.max(activity.maxParticipants - activity.currentParticipants, 0) > 0 && (<p className="text-sm text-orange-600 font-medium">
          ...
          <div className="space-y-3">
            {isInterested ? (<>
                <div className="flex gap-3">
                  ...
                  <Button variant="outline" className="flex-1 border-red-500 text-red-500 hover:bg-red-50" onClick={onToggleInterest}>
                    Cancel Booking
                  </Button>
                </div>
                <Button className="w-full bg-[#5661f6] hover:bg-[#4551e6]" onClick={() => {
              ...
              </>) : (<Button className="w-full bg-[#5661f6] hover:bg-[#4551e6]" onClick={onToggleInterest}>
                Sign Up
              </Button>)}
          </div>
        </div>
