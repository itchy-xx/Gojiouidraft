        ...
        <Card className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="name" defaultValue={currentUser?.name} className="bg-input-background"/>
            </div>

            {/* Email */}
            <div className="space-y-2">
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" defaultValue={currentUser?.email} className="bg-input-background"/>
            </div>

            {/* Neighbourhood */}
            <div className="space-y-2">
              <Label htmlFor="neighbourhood">Neighbourhood</Label>
              <Input id="neighbourhood" defaultValue={currentUser?.neighbourhood} className="bg-input-background"/>
            </div>
          </div>
        </Card>
      </motion.div>
