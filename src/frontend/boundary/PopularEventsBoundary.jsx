    ...
    return (<div className="bg-[#f5f5f7] min-h-screen">
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div className="space-y-4">
          {popularEvents.map((activity, index) => (<div key={activity.id} onClick={() => handleActivityClick(activity)} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all cursor-pointer flex gap-4 p-4">
              {/* Image */}
