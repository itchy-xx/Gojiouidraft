...
export const MapView: React.FC<MapViewProps> = ({ 
  ...
  const getPosition = (activity: Activity) => {
  ...
  return (
    <div 
      ref={mapRef}
      className="relative w-full h-full bg-gradient-to-br from-blue-50 via-green-50 to-blue-100 rounded-lg overflow-hidden"
      style={{
        backgroundImage: `
      ...
      {activities.map((activity) => {
        ...
        return (
          <motion.div
            ...
            onMouseEnter={() => setHoveredPin(activity.id)}
          ...
          >
            ...
            {(isHovered || isSelected) && (
              <motion.div
                ...
                className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-white rounded-xl shadow-2xl overflow-hidden w-[280px] z-10 border border-primary/20"
              >
                {/* Event Image */}
