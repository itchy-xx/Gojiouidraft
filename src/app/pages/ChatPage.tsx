...
import { ArrowLeft, Send, Paperclip, Image, FileText, Smile, MoreVertical } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col bg-white">
      ...
      <div className="border-b p-4 flex items-center gap-3">
        ...
        <img 
          src={isGroupChat ? chatInfo.image : chatInfo.participantAvatar}
          alt={isGroupChat ? chatInfo.title : chatInfo.participantName}
        ...
        <div className="flex-1">
          ...
          {isGroupChat && (
            <p className="text-xs text-gray-500">{chatInfo.participants} members</p>
          )}
        </div>
        ...
        <div className="space-y-4 max-w-3xl mx-auto">
          {messages.length === 0 ? (
            ...
            messages.map((message) => (
              <div 
                key={message.id}
                className={`flex gap-2 ${message.isCurrentUser ? 'flex-row-reverse' : 'flex-row'}`}
              >
                ...
                <div className={`flex flex-col ${message.isCurrentUser ? 'items-end' : 'items-start'} max-w-[70%]`}>
                  {!message.isCurrentUser && isGroupChat && (
      ...
      {/* File Preview */}
      {selectedFile && (
        <div className="border-t px-4 py-2 bg-gray-50 flex items-center gap-2">
