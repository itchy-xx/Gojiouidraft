              ...
              <div className="space-y-2">
                {filteredChats.map((chat) => (
                  <div
                    ...
                    className="bg-white rounded-xl p-4 hover:shadow-md transition-shadow cursor-pointer flex items-center gap-4"
                  >
                    {/* Avatar/Image */}
                    <div className="relative">
                      <img 
                        src={chat.type === 'group' ? chat.image : chat.participantAvatar}
                        alt={chat.type === 'group' ? chat.title : chat.participantName}
                        className="w-16 h-16 rounded-full object-cover"
                      />
                      {chat.type === 'group' && (
                        <div className="absolute -bottom-1 -right-1 bg-[#5661f6] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">
