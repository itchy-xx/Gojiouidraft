          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full h-[48px] bg-[#f7fbff] border border-[#d4d7e3] rounded-[12px] px-4 text-[16px] text-[#0c1421] focus:outline-none focus:ring-2 focus:ring-[#5661f6] focus:border-transparent"
                required
              >
