...
function Intro() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Intro">
...
function Form() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-end justify-center relative shrink-0 w-full" data-name="Form">
...
function SocialSignIn() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Social Sign in">
      <Or />
    </div>
  );
}
...
function LoginForm() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start relative shrink-0 w-[388px]" data-name="Login Form">
      <Intro />
      <Form />
      <SocialSignIn />
